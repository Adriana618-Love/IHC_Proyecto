...
public class DictationEngine : MonoBehaviour
{
    ...
    private bool movementReconagized = true;
    ...
    private void DictationRecognizer_OnDictationHypothesis(string text)
    {
        ...
        movementReconagized = CheckMovement(text);
    ...
    private void DictationRecognizer_OnDictationResult(string text, ConfidenceLevel confidence)
    {
        ...
        if(!movementReconagized)CheckMovement(text);
        movementReconagized = false;
    ...
    private bool CheckMovement(string text)
    {
        if (text.Contains("arriba"))
        {
            Up();return true;
        }
        if (text.Contains("izquierda"))
        {
            Left();return true;
        }
        if (text.Contains("derecha"))
        {
            Right();return true;
        }
        if (text.Contains("abajo"))
        {
            Down();return true;
        }
        return false;
